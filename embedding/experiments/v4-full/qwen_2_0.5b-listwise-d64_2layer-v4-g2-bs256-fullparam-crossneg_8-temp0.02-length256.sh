...
TOKENIZED_TRAIN_DATA=$TRAIN_DATA_FOLDER/qwen2-v1-256-listwise-g2-tokenized
...
output_name=qwen_2_0.5b-listwise-d64_2layer-v4-g2-bs256-fullparam-crossneg_8-temp0.02-length256
...
torchrun $DDP -m main.eval_retrieval --eval_data $eval_data --corpus $eval_data --model_name_or_path $lora --mrl_dims 64 --mrl_2layer_proj True --query_max_length 256 --key_max_length 256

torchrun $DDP -m main.eval_ctr --eval_data $eval_data --model_name_or_path $lora --mrl_dims 64 --mrl_2layer_proj True --query_max_length 256 --key_max_length 256
