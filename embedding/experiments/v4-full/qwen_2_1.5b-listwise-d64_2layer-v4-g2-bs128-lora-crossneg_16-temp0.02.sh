...
output_name=qwen_2_1.5b-listwise-d64_2layer-v4-g2-bs128-lora-crossneg_16-temp0.02
...
torchrun $DDP -m main.eval_retrieval --eval_data $eval_data --corpus $eval_data --model_name_or_path /mnt/bn/search-douyin-rank-yg/all_data_from_lf/llm_models/qwen-2-1.5b --lora $lora --mrl_dims 64 --mrl_2layer_proj True

torchrun $DDP -m main.eval_ctr --eval_data $eval_data --model_name_or_path /mnt/bn/search-douyin-rank-yg/all_data_from_lf/llm_models/qwen-2-1.5b --lora $lora --mrl_dims 64 --mrl_2layer_proj True
