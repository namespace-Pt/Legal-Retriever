...
output_name=qwen_2_0.5b-0.8list_0.2point-d64_2layer-v4-g2-bs256-fullparam-crossneg_8-temp0.02_0.2

# accelerate launch --config_file data/config/qwen2/acc-zero2.yaml --main_process_port 12345 -m main.train \
...
if [ $NODE_RANK = 0 ]; then
cp data/outputs/$output_name /mnt/bn/search-douyin-rank-yg/all_data_from_lf/peitian_data/data/outputs/ -rf
fi

# NOTE: we must wait untill the main process has copied the weights to shared disk
sleep 10
