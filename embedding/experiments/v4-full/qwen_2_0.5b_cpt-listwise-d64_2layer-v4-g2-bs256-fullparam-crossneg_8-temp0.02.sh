...
TOKENIZED_TRAIN_DATA=$TRAIN_DATA_FOLDER/qwen2_cpt-v1-512-listwise-g2-tokenized

if [ ! -d $TOKENIZED_TRAIN_DATA ]; then

torchrun $DDP -m main.prepare_train_data \
--model_name_or_path /mnt/bn/search-douyin-rank-yg/all_data_from_lf/experiments/pretrain_llm/train_outputs/trainset-pretrain-query_doc_from_yunyi_202310_2024060301_200part-prob-1-qwen2_0_5b_fast-full-lorarank8-vanilla-cl4096-ms10000-bs2-gas32-lr1e-4-z0-cloudnative-lf-2ins8gpus-ri1001 \
...
output_name=qwen_2_0.5b-listwise-d64_2layer-v4-g2-bs256-fullparam-crossneg_8-temp0.02
