...
output_name=qwen_2_7b-listwise-d64_2layer-v4-g2-bs16-fullparam-crossneg_128-temp0.02

torchrun $DDP -m main.train --deepspeed data/config/qwen2/zero2-offload.json \
--output_dir /mnt/bn/search-douyin-rank-yg/all_data_from_lf/peitian_data/data/outputs/$output_name \
--model_name_or_path /mnt/bn/search-douyin-rank-yg/all_data_from_lf/llm_models/qwen-2-7b \
