...
torchrun $DDP -m main.eval_retrieval --eval_data $eval_data --corpus $eval_data --model_name_or_path $model --mrl_dims 64 --mrl_2layer_proj True

torchrun $DDP -m main.eval_ctr --eval_data $eval_data --model_name_or_path $model --mrl_dims 64 --mrl_2layer_proj True
